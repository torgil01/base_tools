function tp = imSegTruePos(imA,imRef)
% function tp = imSegTruePos(imA,imRef)
% return true positive ration (tp) between a binary image (0|1) imA and a reference image 
% imRef. tp is defined as
%   tp = overlap(imA,imRef)/vol(imRef)
% imA and imRef are NII images
% ---------------------------------------------
% See Shiee NI 2009 for definition of TP 
